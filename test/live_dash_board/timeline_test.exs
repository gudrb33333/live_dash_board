defmodule LiveDashBoard.TimelineTest do
  use LiveDashBoard.DataCase

  alias LiveDashBoard.Timeline

  describe "posts" do
    alias LiveDashBoard.Timeline.Post

    import LiveDashBoard.TimelineFixtures
    ...
    test "create_post/1 with valid data creates a post" do
      valid_attrs = %{body: "some body", like_count: 42, reports_count: 42, username: "some username"}
